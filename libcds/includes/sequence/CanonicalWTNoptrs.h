...
class CanonicalWTNoptrs : public Sequence {
  ...
  public:
	...
	CanonicalWTNoptrs(uint * symbols, uint n, wt_coder_huff *wc, vector<BitSequenceBuilder *> &bsbs, Mapper * am, MappingBuilder *msb,  bool deleteSymbols=false);
	
	CanonicalWTNoptrs(uint * symbols, uint n, wt_coder_huff_can *wc, vector<BitSequenceBuilder *> &bsbs, Mapper * am, MappingBuilder *msb,  bool deleteSymbols=false);

    CanonicalWTNoptrs(uint * symbols, uint n,  vector<BitSequenceBuilder *> &bmb, Mapper * am,  MappingBuilder *msb, bool deleteSymbols = false);
  ...
  protected:
	...
	void build(uint *symbols, uint max_v, wt_coder_huff_can *wc, vector<BitSequenceBuilder *> &bmb, Mapper * am,  MappingBuilder *msb);
