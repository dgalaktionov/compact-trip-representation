...
namespace cds_utils
{
    ...
    /*
     * Returns a temporary fileName. If directory is provided, that file
     * will be inside that directory. Doesn't offer any concurrence guarantees.
     */
    string GetTemporalFileName(const string &directory=string());
