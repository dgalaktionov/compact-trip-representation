...
//        {
//            vector<pair<ulong,ulong>> occ(max_v+1);
//            uint i=0;
//            for (auto &it:occ) {
//                it.first = i++;
//                it.second = 0UL;
//            }
//            for (uint i = 0; i < n; i++) {
//                occ[symbols[i]].second++;
//            }
//            sort(occ.begin(),occ.end(),[](const pair<ulong,ulong> &p1, const pair<ulong,ulong> &p2){return p1.second<p2.second;});
//            vector<uint> recode(max_v+1);
//            for (uint i=0;i<=max_v;i++){
//                recode[occ[i].first]=i;
//            }
//            for (ulong i=0;i<n;i++)
//                symbols[i] = recode[symbols[i]];
//        }
