...
DAC::DAC(uint *input,uint list_length,bool del):DirectAccess(){
	...
	kvalues = optimizationk(list,(int)listLength,&nkvalues);
...
uint DAC::access(uint param) const{
