	...
	class BP: public Parentheses{
	  public:
	  	/**
			...
			(each block of 32 bits) has to be in reverse order!! That is because bp_bitget at
			bp-utils.h works in this way (i do not know why and i do not want to
			...
			TODO solve this (maybe changing the function bp_bitget). At least
